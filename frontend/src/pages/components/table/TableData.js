...
import { findUpper, goProductCollapse, goPolicyCollapse } from "../../../utils/Utils";
...
export const dataTableColumns1 = [
  {
    name: "Product Name",
  ...
  },
  {
    ...
    cell: (row) => (
      <div className="user-card mt-2 mb-2">
        <Link to="productPanel" spy={true} smooth={true}>
          <Button color="" className="btn-icon" onClick={() => goProductCollapse(row.id)}>
              <span>Edit</span>
          </Button>
        </Link>
      </div>
...
export const dataTableColumns11 = [
  {
    name: "Product Name",
    selector: (row) => row.c_productname,
    sortable: true,
  ...
  },
  {
    ...
    cell: (row) => (
      <div className="user-card mt-2 mb-2">
        <Link to="productPanel" spy={true} smooth={true}>
          <Button color="" className="btn-icon" onClick={() => goProductCollapse(row.id, true)}>
              <span>Edit</span>
          </Button>
        </Link>
      </div>
...
export const TableColumns_allpolicy = [
  {
    name: "",
    ...
    cell: (row) => (
      <div className="user-card mt-2 mb-2">
        <Input type="checkbox" name="check" id="policycheckall" className="checkall" ></Input>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: (row) => (
      <div className="tb-tnx-desc">
          <Input type="checkbox" name="check" id="companycheckall" className="checkall"></Input>
      </div>
    ),
  },
  {
    name: "",
    selector: (row) => row.aaa,
    sortable: true,
    hide: "md",
    cell: (row) => (
      <div>
