...
//Insurance
import ProductManage from "../pages/insurance/productmanage";
import PolicyManage from "../pages/insurance/policymanage";
import UserPolicyManage from "../pages/insurance/userpolicymanage";
import ViewAllPolicies from "../pages/insurance/viewAllPolicies";
import BillingOptions from "../pages/insurance/billingOptions";
import ContactManage from "../pages/insurance/contactManage";
import ConfirmPay from "../pages/insurance/confirmPay";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        {/*Insurance Pages*/}
        <Route exact path={`${process.env.PUBLIC_URL}/productmanage`} component={ProductManage}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/policymanage`} component={PolicyManage}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/policyuser`} component={UserPolicyManage}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/viewpolicies`} component={ViewAllPolicies}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/billing`} component={BillingOptions}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/contact`} component={ContactManage}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/payment`} component={ConfirmPay}></Route>
